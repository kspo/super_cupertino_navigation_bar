...
class LargeTitleWithPinnedSearch extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    final bool showLargeTitle =
        scrollController.offset > Measures.searchBarHeight;
        ...
        child: Stack(
          children: <Widget>[
            Positioned(
              ...
              left: 0.0,
              right: 0.0,
              bottom: Measures.searchBarHeight,
            ...
            avatarModel.avatarIsVisible
                ? Positioned(
                    ...
                    top: persistentHeight,
                    bottom: clampDouble(
                        Measures.searchBarHeight - scrollController.offset,
                        0,
                            ...
                            child: AnimatedOpacity(
                              ...
                              child: Container(
                                transform: Matrix4.translationValues(
                                    0,
                                    clampDouble(-scrollController.offset,
            ...
            Positioned(
              left: 15.0,
              right: 15.0,
              bottom: 5 + Measures.collapsedBottomPadding,
              child: SizedBox(
    ...
    return Hero(
      ...
      child: TransitionableNavigationBar(
        ...
        largeExpanded: !showLargeTitle && !hasFocusValueNotifier.value,
        searchBarHasFocus: hasFocusValueNotifier.value,
        child: navBar,
      ),
    );
  }
