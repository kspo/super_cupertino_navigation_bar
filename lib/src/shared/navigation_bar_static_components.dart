...
import 'package:super_cupertino_navigation_bar/src/shared/back_chevron.dart';
import 'package:super_cupertino_navigation_bar/src/shared/back_label.dart';
...
class NavigationBarStaticComponents {
    ...
    return KeyedSubtree(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.only(
          start: padding?.start ?? Measures.navBarEdgePadding,
        ),
  ...
  static KeyedSubtree? createTrailing({
    ...
    return KeyedSubtree(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.only(
          end: padding?.end ?? Measures.navBarEdgePadding,
        ),
        child: IconTheme.merge(
          data: const IconThemeData(
            size: 32.0,
