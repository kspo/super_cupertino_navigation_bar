        ...
        AnimatedContainer(
          ...
          child: Row(
            children: [
                  ...
                  child: SizedBox.expand(
                    child: TextSelectionTheme(
                      data: TextSelectionThemeData(
                          cursorColor:
                              widget.searchFieldDecoration.cursorColor),
                      child: Stack(
                        children: [
                          Positioned(
                            top: 0,
                            ...
                            child: KeyedSubtree(
                              ...
                              child: Container(
                                decoration: widget
                                        .searchFieldDecoration.decoration ??
                                    BoxDecoration(
                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                        ...
                                        child: ValueListenableBuilder(
                                          ...
                                          builder: (context, searchBarHasData,
                                              child) {
                          ...
                          CupertinoSearchTextField(
                            ...
                            onChanged: (text) {
                              ...
                              widget.searchFieldDecoration.onChanged
                                  ?.call(text);
                            },
                            // backgroundColor: widget.searchFieldDecoration.backgroundColor,
                            onSubmitted:
                                widget.searchFieldDecoration.onSubmitted,
                            placeholder: "",
                            /*placeholderStyle:
                            ...
                            keyboardType:
                                widget.searchFieldDecoration.keyboardType,
                            ...
                            suffixInsets:
                                widget.searchFieldDecoration.suffixInsets,
                          ),
                        ],
                      ),
                    ),
              ...
              for (var searchAction
                  in widget.searchFieldDecoration.actionButtons)
                searchAction.actionButtonsBehaviour ==
