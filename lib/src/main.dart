...
import 'package:super_cupertino_navigation_bar/utils/back_button.dart';
...
class SuperScaffold extends StatefulWidget {
  SuperScaffold({
    ...
    measures = Measures(
      searchBarheightx: appBar!.searchBar!.height,
      largeTitleToolbarHeightx: appBar!.largeTitle!.height,
      primaryToolbarHeightx: appBar!.height,
      bottomToolbarHeightx: appBar!.bottom!.height,
...
class _SuperScaffoldState extends State<SuperScaffold> with RouteAware {
  ...
  setMagnifier() {
    if (widget.appBar!.searchBar!.scrollBehavior ==
        SearchBarScrollBehavior.floated) {
      if (_scrollOffset < widget.measures!.secondaryToolbarHeight / 2) {
        _scrollController.animateTo(
          0,
          duration: widget.measures!.scrollAnimationDuration,
          curve: Curves.ease,
        );
      } else if (_scrollOffset > widget.measures!.secondaryToolbarHeight / 2 &&
          _scrollOffset <
              widget.measures!.secondaryToolbarHeight +
                  widget.measures!.thirthToolbarHeight / 2) {
        _scrollController.animateTo(
          widget.measures!.secondaryToolbarHeight,
          duration: widget.measures!.scrollAnimationDuration,
          curve: Curves.ease,
      ...
      if (_scrollOffset < widget.measures!.thirthToolbarHeight / 2) {
        _scrollController.animateTo(
          0,
          duration: widget.measures!.scrollAnimationDuration,
          curve: Curves.ease,
        );
      } else if (_scrollOffset > widget.measures!.thirthToolbarHeight / 2 &&
          _scrollOffset < widget.measures!.thirthToolbarHeight) {
        _scrollController.animateTo(
          widget.measures!.thirthToolbarHeight,
          duration: widget.measures!.scrollAnimationDuration,
          curve: Curves.ease,
            ...
            children: [
              SingleChildScrollView(
                physics: SnapScrollPhysics(
                  snaps: [
                    if (widget.appBar!.searchBar!.scrollBehavior ==
                        SearchBarScrollBehavior.floated)
                      Snap.avoidZone(
                          0, widget.measures!.secondaryToolbarHeight),
                    if (widget.appBar!.searchBar!.scrollBehavior ==
                        SearchBarScrollBehavior.floated)
                      Snap.avoidZone(
                          widget.measures!.secondaryToolbarHeight,
                    ...
                    if (widget.appBar!.searchBar!.scrollBehavior ==
                      ...
                      Snap.avoidZone(0, widget.measures!.thirthToolbarHeight),
                  ],
                ),
                ...
                child: Column(
                  children: [
                          ...
                          return AnimatedContainer(
                            ...
                            height: Store.instance.searchBarHasFocus.value
                                ? (widget.appBar!.searchBar!.animationBehavior ==
                                    ...
                                    ? topPadding +
                                        widget
                                            .measures!.secondaryToolbarHeight +
                    ...
                    if (widget.body.isNotEmpty) ...widget.body,
                  ],
                ),
              ),
              ValueListenableBuilder(
              ...
              ValueListenableBuilder(
                ...
                builder: (context, scrollOffset, child) {
                  ...
                  // full height of bottom appbar
                  double bottomToolbarHeight = widget
                              .appBar!.searchBar!.scrollBehavior ==
                          SearchBarScrollBehavior.floated
                      ? clampDouble(
                          widget.measures!.appbarHeightExceptPrimaryToolbar -
                              _scrollOffset,
                          0 + widget.appBar!.bottom!.height,
                          widget.measures!.appbarHeightExceptPrimaryToolbar)
                      : clampDouble(
                          widget.measures!.appbarHeightExceptPrimaryToolbar -
                              _scrollOffset,
                  ...
                  double largeTitleHeight = widget
                              .appBar!.searchBar!.scrollBehavior ==
                          SearchBarScrollBehavior.floated
                      ? (_scrollOffset > widget.measures!.secondaryToolbarHeight
                          ? clampDouble(
                              widget.measures!.thirthToolbarHeight -
                                  (_scrollOffset -
                                      widget.measures!.secondaryToolbarHeight),
                          ...
                          : widget.measures!.thirthToolbarHeight)
                      : clampDouble(
                          widget.measures!.thirthToolbarHeight - _scrollOffset,
                          0,
                          widget.measures!.thirthToolbarHeight);

                  // searchbar height
                  double searchBarHeight = widget
                              .appBar!.searchBar!.scrollBehavior ==
                          SearchBarScrollBehavior.floated
                      ? (Store.instance.searchBarHasFocus.value
                          ? widget.measures!.searchBarHeight
                          : clampDouble(
                              widget.measures!.searchBarHeight - _scrollOffset,
                              0,
                              widget.measures!.searchBarHeight))
                      : widget.measures!.searchBarHeight;
                  ...
                  double titleOpacity = widget
                      ...
                      ? (_scrollOffset >=
                              (widget.measures!
                                  ...
                                  widget.appBar!.bottom!.height)
                          ? 1
                          : (widget.measures!.thirthToolbarHeight > 0 ? 0 : 1))
                      : (_scrollOffset >= (widget.measures!.thirthToolbarHeight)
                          ? 1
                          : (widget.measures!.thirthToolbarHeight > 0 ? 0 : 1));
                  ...
                  if (widget.appBar!.searchBar!.animationBehavior ==
                    ...
                    bottomToolbarHeight =
                        widget.measures!.appbarHeightExceptPrimaryToolbar;
                    largeTitleHeight = widget.measures!.thirthToolbarHeight;
                    scaleTitle = 1;
                    titleOpacity = 0;
                  }
                          ...
                          child: ClipRect(
                            child: BackdropFilter(
                              ...
                              child: Builder(builder: (context) {
                                Widget childd = AppBar(
                                  shape: Border(
                                      bottom: widget.appBar!.bottomBorder ??
                                          BorderSide.none),
                                  actions: [
                                    AnimatedOpacity(
                                      duration: animationStatus ==
                                  ...
                                  leadingWidth: widget.appBar!.leadingWidth ??
                                      textSize(widget.appBar!.previousPageTitle,
                                              const TextStyle()) *
                                          1.5,
                                  ...
                                  title: AnimatedOpacity(
                                    ...
                                    duration: widget
                                        .measures!.standartAnimationDuration,
                                    child: components.middle,
                                  ),
                                  toolbarHeight:
                                      widget.measures!.primaryToolbarHeight,
                                        ...
                                        children: [
                                                                  ...
                                                                  firstChild:
                                                                    ...
                                                                    child: Row(
                                                                      children: widget
                                                                          ...
                                                                          .where((e) =>
                                                                              e.behavior ==
                                                                              SuperActionBehavior.visibleOnFocus)
                                                                          .toList(),
                                                                    ),
                                                                  ),
                                                                  secondChild:
                                                                  ...
                                                                  firstChild:
                                                                    ...
                                                                    child: Row(
                                                                      children: widget
                                                                          ...
                                                                          .where((e) =>
                                                                              e.behavior ==
                                                                              SuperActionBehavior.visibleOnUnFocus)
                                                                          .toList(),
                                                                    ),
                                                                  ),
                                                                  secondChild:
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    width: Store
                                                                            ...
                                                                            .value
                                                                        ? textSize(
                                                                            widget.appBar!.searchBar!.cancelButtonText,
                                                                            widget.appBar!.searchBar!.cancelTextStyle)
                                                                        : 0,
                                                                    child:
                                                                        Align(
                                                                      alignment:
                                          ...
                                          AnimatedContainer(
                                            ...
                                            child: Stack(
                                              ...
                                              children: [
                                                Positioned(
                                                  height: widget.measures!
                                                      .bottomToolbarHeight,
                                                  bottom: 0,
                                                  left: 0,
                                                  right: 0,
                                                  child:
                                                      components.appbarBottom!,
                                                ),
                                              ],
                                            ),
                                          ),
                                  ...
                                  child: TransitionableNavigationBar(
                                    ...
                                    backButtonTextStyle:
                                        CupertinoTheme.of(context)
                                            .textTheme
                                            .navActionTextStyle,
                                    titleTextStyle: (widget.appBar!.title
                                            is Text)
                                        ? (widget.appBar!.title as Text)
                                            .style!
                                            .merge(CupertinoTheme.of(context)
                                                .textTheme
                                                .navTitleTextStyle)
                                            .copyWith(
                                              fontSize: 20,
